                ...
                <form class="modal-content" id="viewing">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                            ...
                            <div class="button-wrapper">
                                <button disabled class="btn btn-primary me-2 mb-2" tabindex="0">Operator</button>
...
@section('admin_content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-3">
            <span class="text-muted fw-light">Bus Schedule /</span> Assigned Schedules
        </h4>
        ...
        <div class="card">
            <div class="card-header color">
                ...
                @foreach($schedule as $sched)
                    @if($sched->company_id == Auth::user()->company_id)
                        @if($sched->status == 1)
                            <?php $cnt_schedule += 1;?>
                        @endif
                    @endif
