    ...
    <?php $count = 0; ?>
        <tr class="tbl">
            ...
            <td>
                ...
                @endif
                @if($o==null)
                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Operator : {{$o_name}} @if($o_status == 1)(Active) @elseif($o_status == 2)(Not Active) @endif">
                        <img src="{{ asset('assets/img/avatars/default.jpg') }}" alt="Avatar" class="rounded-circle" />
                    </li>
                @else
                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar avatar-xs pull-up" title="Operator : {{$o_name}} @if($o_status == 1)(Active) @elseif($o_status == 2)(Not Active) @endif">
