        ...
        <section class="breadcrumbs track">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="text-dark">Real-Time <span>Bus Location</span> </h2>
                    <ol>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="portfolio-info mt-4" >
                            ...
                            <ul><span class="badge bg-label-warning me-1">Bus Maintenace</span> Bus is on maintenace, wait for another status.</ul>
                        </div>
                    </div>
                </div>
            </div>
